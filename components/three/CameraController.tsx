...
const CAMERA_KEYFRAMES: Record<ProjectId, {
  ...
  agrisense: {
    entry: {
      position: [0.4, -0.35, 5.9],
      target: [-0.8, 0, 0],
      fov: 47,
    },
    active: {
      position: [1.05, 0.46, 4.8],
      target: [-0.55, 0.14, 0],
      fov: 40,
    },
    exit: {
      position: [1.5, 0.9, 4.35],
      target: [-0.2, 0.28, 0],
      fov: 41,
    },
  },
  esp32: {
    entry: {
      position: [-0.9, 0.75, 4.8],
      target: [0.8, 0.05, 0],
      fov: 46,
    },
    active: {
      position: [-0.15, 1, 3.95],
      target: [0.95, 0.05, 0],
      fov: 47,
    },
    exit: {
      position: [0.9, 0.85, 4.2],
      target: [0.7, 0.08, 0],
      fov: 44,
    },
  },
  arms: {
    entry: {
      position: [0.3, 0.4, 5.3],
      target: [-0.9, 0.45, -0.05],
      fov: 45,
    },
    active: {
      position: [0.75, 0.48, 4],
      target: [-1.05, 0.42, -0.06],
      fov: 41,
    },
    exit: {
      position: [0.2, 0.75, 4.7],
      target: [-0.8, 0.25, -0.05],
      fov: 44,
    },
  },
  realitech: {
    entry: {
      position: [-0.2, 0.85, 5.1],
      target: [1.05, 0.08, 0],
      fov: 47,
    },
    active: {
      position: [-0.15, 0.6, 4.4],
      target: [1.1, 0.1, 0],
      fov: 43,
    },
    exit: {
